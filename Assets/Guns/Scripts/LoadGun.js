...
var toolbarStrings : String[] = ["Gun0", "Gun1", "Gun2","Gun3","Gun4","Gun5", "Reload"];
...
function playSound (soundClip:AudioClip, speed:float){
      	...
      	this.GetComponent.<AudioSource>().pitch=speed; 
 ...
 toolbarInt = GUI.Toolbar (Rect (10, 10, 640, 40), toolbarInt, toolbarStrings);
